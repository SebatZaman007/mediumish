<!DOCTYPE html>
<html lang="en">
@include('admin.frontend.include.head')
<body>
...
<div class="container">
	...
	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		...
		<ul class="navbar-nav ml-auto">
			...
			<a class="nav-link" href="{{route('add.stories')}}">Stories <span class="sr-only">(current)</span></a>
			</li>
		</ul>
	</div>
</div>
        ...
        <div class="card">
			<div class="row">
				<div class="col-md-5 wrapthumbnail">
					<a href="post.html">
						<div class="thumbnail" style="background-image:url({{'/uploads/students/'.$item->image_big}});">
						</div>
					</a>
				</div>
				<div class="col-md-7">
					<div class="card-block">
						<h2 class="card-title"><a href="post.html">{{$item->title}}</a></h2>
						<h4 class="card-text">{{$item->description}}</h4>
						<div class="metafooter">
							<div class="wrapfooter">
								<span class="meta-footer-thumb">
								<a href="author.html"><img class="author-thumb" src="{{asset('/uploads/students/'.$item->image_one)}}" alt="Sal"></a>
								</span>
...
@include('admin.frontend.include.script')
</body>
</html>
